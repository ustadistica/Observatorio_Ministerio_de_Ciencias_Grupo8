...
% =====================================================================
\section{Eje 4 — Trayectoria longitudinal}\label{sec:longitudinal}
% =====================================================================
...
\subsection{Género × territorio}\label{ssec:h7b-genero-territorio}

\begin{hallazgo}
\textbf{Hallazgo 7b.} Ningún departamento alcanza la paridad de género entre los investigadores reconocidos. El máximo es Boyacá con 42\,\%. En el otro extremo, Risaralda registra 30\,\% e investigadores con residencia en el exterior 29\,\%.
\end{hallazgo}

\begin{figure}[h]
\centering
\includegraphics[width=0.92\linewidth]{../../artifacts/sprint7_genero/fig_genero_territorial.png}
\caption{Porcentaje de mujeres por departamento de residencia (top quince por volumen total).}
\end{figure}

La brecha de género en territorio es persistente. El promedio nacional del 40\,\% oculta variaciones notables, pero ninguna región del país muestra paridad efectiva. Esto importa cuando se diseñan programas focalizados regionales: el componente de género no puede asumirse resuelto por el simple aumento de cobertura territorial.

% =====================================================================
\section{Género como lente transversal}\label{sec:genero}
% =====================================================================

A diferencia de los cuatro ejes (producción, territorios, campos OCDE y análisis longitudinal), el género no se trata como un capítulo aislado sino como una dimensión que atraviesa los demás. Esta sección consolida los hallazgos de género integrados en cada eje.

\subsection{Género × campos OCDE (2021)}\label{ssec:h8}

\begin{hallazgo}
\textbf{Hallazgo 8.} En la convocatoria 2021, sólo Ciencias Médicas y de la Salud (50{,}9\,\%) supera la paridad de género entre los investigadores reconocidos. Ingeniería y Tecnología registra el mínimo (26{,}5\,\%); Ciencias Sociales se aproxima a la paridad (45{,}1\,\%) pero no la alcanza.
\end{hallazgo}

\begin{figure}[h]
\centering
\includegraphics[width=0.95\linewidth]{../../artifacts/sprint7_genero/fig_genero_ocde_2021.png}
\caption{Porcentaje de mujeres por gran área OCDE en la convocatoria 2021. Línea de paridad al 50\,\%.}
\end{figure}

La cifra agregada del 40\,\% nacional refleja una mezcla muy desigual: paridad en Médicas, sub-representación fuerte en STEM, intermedio en Sociales/Humanidades. El comportamiento es consistente con la serie longitudinal de las seis convocatorias --- la brecha STEM se mantiene plana durante una década.

\subsection{Género × producción}\label{ssec:h9}
...
\subsection{Género × territorio (síntesis)}

El hallazgo correspondiente está detallado en la sección \ref{ssec:h7b-genero-territorio} del Eje 2. En síntesis: \emph{ningún departamento alcanza la paridad}, con Boyacá (42\,\%), Bolívar (42\,\%) y Cundinamarca (41\,\%) como techo. Risaralda y Caldas se ubican en torno al 30\,\%. La brecha territorial es persistente.
